...
$egExtensionLoaderConfig += array(
	...
	'TalkRight' => array(
		'git' => 'https://$githubtoken:x-oauth-basic@github.com/enterprisemediawiki/TalkRight.git',
		'branch' => 'master',
	),
	...
	'CopyWatchers' => array(
		'git' => 'https://$githubtoken:x-oauth-basic@github.com/jamesmontalvo3/MediaWiki-CopyWatchers.git',
		'branch' => 'master',
	),
	...
	'Wiretap' => array(
		'git' => 'https://$githubtoken:x-oauth-basic@github.com/enterprisemediawiki/Wiretap.git',
		'branch' => 'master',
	),

	'ApprovedRevs' => array(
		'git' => 'https://$githubtoken:x-oauth-basic@github.com/jamesmontalvo3/MediaWiki-ApprovedRevs.git',
		'branch' => 'master',
		'globals' => array(
	...
	'IMSQuery' => array(
		'git' => 'https://$githubtoken:x-oauth-basic@github.com/jamesmontalvo3/IMSQuery.git',
		'branch' => 'master',
	),

	'MasonryMainPage' => array(
		'git' => 'https://$githubtoken:x-oauth-basic@github.com/enterprisemediawiki/MasonryMainPage.git',
		'branch' => 'master',
	),

	'WatchAnalytics' => array(
		'git' => 'https://$githubtoken:x-oauth-basic@github.com/enterprisemediawiki/WatchAnalytics.git',
		'branch' => 'master',
		'globals' => array(
	...
	'SummaryTimeline' => array(
		'git' => 'https://$githubtoken:x-oauth-basic@github.com/darenwelsh/SummaryTimeline.git',
		'branch' => 'master',
	),
	 ...
	 */
	'PipeEscape' => array(
		'git' => 'https://$githubtoken:x-oauth-basic@github.com/jamesmontalvo3/MediaWiki-PipeEscape.git',
		'branch' => 'master',
	),
